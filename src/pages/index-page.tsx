  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-10 text-xl text-muted-foreground">
            Create professional, ATS-friendly resumes with our intelligent CV builder. Stand out from
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Why Choose CV Builder Pro?</h2>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create a professional CV in under 10 minutes with our streamlined process
                </CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Templates designed to pass Applicant Tracking Systems and reach recruiters
                </CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Templates created by HR professionals and recruiting experts
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
