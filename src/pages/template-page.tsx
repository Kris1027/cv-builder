...
import { sampleCVDataPl, sampleDefaultCVDataPl, sampleVeterinaryCVDataPl } from '@/data/sample-cv-data-pl';
...
export function TemplatePage() {
  ...
  const renderTemplate = () => {
    switch (templateId) {
      ...
      case 'default':
        return <DefaultTemplate data={isPolish ? sampleDefaultCVDataPl : sampleDefaultCVData} />;
      case 'veterinary':
        return <VeterinaryTemplate data={isPolish ? sampleVeterinaryCVDataPl : sampleVeterinaryCVData} />;
      default:
        return (
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold dark:text-gray-100">{getTemplateName()} {t('templates.preview')}</h1>
            </div>
